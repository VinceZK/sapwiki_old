...
(ert-deftest dk-collect-attachments ()
  ...
  (should (equal (symbol-name (car (car (car dk-sapwiki-attachments)))) "file_0"))
  (dk-collect-attachments "../image/TextRuleEditor.png")
  (should (equal (symbol-name (car (car (car dk-sapwiki-attachments)))) "file_1"))
  (dk-collect-attachments "../image/TextRuleEditor.png")
  (dk-collect-attachments "../image/TextRuleEditor.png")
  (dk-collect-attachments "../image/TextRuleEditor.png")
  (dk-collect-attachments "../image/TextRuleEditor.png")
  ...
  (should (equal (symbol-name (car (car (car dk-sapwiki-attachment-comments)))) "comment_0"))
  (dk-collect-attachment-comments "Text Rule Editor")
  (should (equal (symbol-name (car (car (car dk-sapwiki-attachment-comments)))) "comment_1"))
  (dk-collect-attachment-comments "Test Caption 1")
  (dk-collect-attachment-comments "Test Caption 2")
  (dk-collect-attachment-comments "Test Caption 3")
  (dk-collect-attachment-comments "Test Caption 4")
  (dk-collect-attachment-comments "Test Caption 5")
  (dk-collect-attachment-comments "Test Caption 6")
  (dk-collect-attachment-comments "Test Caption 7")
  (dk-collect-attachment-comments "Test Caption 8")
  (should (equal (symbol-name (car (car (car dk-sapwiki-attachment-comments)))) "comment_4"))
  (should (equal (cdr (car (car dk-sapwiki-attachment-comments))) "Test Caption 8"))
  (setq dk-sapwiki-attachment-comments ()))
