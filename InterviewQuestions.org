...
Suppose you have a blog website on which you post your own essays and articles. All the contents are public. However, now you want some of the contents to be restrict to the registered users who have accounts of your website. The pitty thing is that your website doesn't has the user login and accessing module, you have to develop one by yourself.

You then conclude the requirements like bellow:
...
You may add more stories to make requirements more close to reality. However, you are mainly asked to detailize each story in following format:
