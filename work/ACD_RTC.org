...
Helmut has decribed 3 kinds of data that RTC could take care of:

*Reported financial data on line item level*
/This is the data which CF takes care of already: the FI line items. This is the basis of the consolidation, and normally comes from an FI system. However, we have to take care of special situations and the transformations that typically take place when the data is copied from the local accounting to the group accounting/
