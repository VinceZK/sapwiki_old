...
RTC mainly interacts with 3 SAP applications: CF, BPC, and IBPF. The 4 applications take roles as following:
...
4. *IBPF* is highly integrated with RTC. Which can do planning and simulation on the consolidation results, and vice veras. 

Detail relationship and interactions can be found in the following diagram.
