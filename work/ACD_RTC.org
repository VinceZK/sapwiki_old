...
| Attachment Service |                 | Yes   | must   | Fiori Attachment Service is a reusable component for Firoi apps that need to upload and store documents into S4HANA system. |
