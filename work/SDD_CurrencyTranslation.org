...
#+BEGIN_SRC sql
CREATE PROCEDURE "ZHANGVIN"."TEST_CT"(  OUT ET_OUT "SAPER9"."DEBUG043002#C500VINCE2#CT" )
LANGUAGE SQLSCRIPT
...
LT_ENTITIES = SELECT ENTITY FROM SAPER9.RTC_ENTITY_M WHERE MANDT='500' AND DIM='100' AND ENTITY ='C1011';

CALL "SAPER9"."/1BCAMDP/DEBUG043002#C500VINCE2#PERIOD"     (
       P_RTC_CATG=>'ACTUAL',
       P_ACCTP=>'C1',
       P_RVERS=>'100',
       P_RYEAR=>'2017',
       ...
       ET_OUT=>LT_OUT_PERIOD
);

CALL "/1BCAMDP/DEBUG043002#C500VINCE2#HISTORY"(
       P_RTC_CATG=>'ACTUAL',
       P_ACCTP=>'C1',
       P_RVERS=>'100',
       P_RYEAR=>'2017',
       ...
       P_REF_DATE => '20170131',
       IT_ENTITIES=>:LT_ENTITIES,
       ET_OUT => LT_OUT_HISTORY
);

ET_OUT = SELECT * FROM :LT_OUT_PERIOD
         UNION ALL SELECT * FROM :LT_OUT_HISTORY ORDER BY ENTITY, PENTITY, RACCT;
