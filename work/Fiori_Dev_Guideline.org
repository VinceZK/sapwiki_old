...
*** Maintian Validation Rule                                           :Steve:
| Artifacts                         | Name                                      |
|-----------------------------------+-------------------------------------------|
...
*** Maintian Validation Method                                        :Summer:
| Artifacts                         | Name                                        |
|-----------------------------------+---------------------------------------------|
...
| Fiori ID                          | F2638                                     |
| BSP Application Name              | FIN_CONS_DOCLIST                          |
...
| Artifacts                         | Name                                |
|-----------------------------------+-------------------------------------|
| Package for Fiori App(UXT)        | UIFIN_CONS/FIN_CONS_RCOMMENTS       |
| Package for OData(ER9)            | APPL_FIN_ODATA_CONS/ODATA_RCOMMENTS |
| App name and ID in Project Portal | fin.cons.lib.comments               |
| POM Artifact ID                   | fin.cons.lib.comments               |
| Fiori ID                          |                                     |
| BSP Application Name              | FIN_COMMENTS                        |
| Service Builder Project           | CONS_COMMENTS                       |
