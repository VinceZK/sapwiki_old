...
As described above, modeling validation happens before consolidation view generation and model activation. There wold be no less that than following rules should be checked:
