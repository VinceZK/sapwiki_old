...
Customizing of the Differential Items: Account and TTYPE. Account is assigned with fix values on both Debit and Credit; TTYPE is empty, which means take the value of the source lines. 
| Field          | Debit              | Credit        |
|----------------+--------------------+---------------|
